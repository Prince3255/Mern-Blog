  ...
  return (
    <div className='group relative w-full border border-teal-500 hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[360px] transition-all'>
        ...
        <div className='p-3 flex flex-col gap-2'>
            ...
            <Link to={`/post/${post.slug}`} className='border border-teal-500 rounded-md !rounded-tl-none m-2 text-center py-2 z-10 group-hover:bottom-0 absolute bottom-[-200px] left-0 right-0 text-teal-500 hover:text-white hover:bg-teal-500 transition-all duration-300'>
                Read article
            </Link>
        </div>
    </div>
